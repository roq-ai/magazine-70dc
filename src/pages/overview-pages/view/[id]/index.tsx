...
import { getOverviewPageById } from 'apiSdk/overview-pages';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('overview_page', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/overview-pages/edit/${data?.id}`} passHref legacyBehavior>
              <Button
